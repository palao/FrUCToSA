...
from fructosa.qmessage import QMessage, UnsuitableQMessage, WrongPickleMessage
...
class QMessageTestCase(unittest.TestCase):
    ...
    @patch("fructosa.qmessage.QMessage._identify_message_type")
    @patch("fructosa.qmessage.pickle.loads")
    ...
    @patch("fructosa.qmessage.QMessage._identify_message_type")
    @patch("fructosa.qmessage.QMessage._pack_for_graphite")
    @patch("fructosa.qmessage.QMessage._arrange_for_graphite")
